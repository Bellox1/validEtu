...
const LandingPage: React.FC = () => {
  ...
  const animationDuration = 3000; // Durée de chaque intervalle en millisecondes (3 secondes)
  const imageSize = 250; // Taille de l'image augmentée à 250 pixels (augmenté de 200 à 250)
  const borderRadius = 20; // Rayon de l'arrondi des bords augmenté (de 10 à 20)

  // États pour la rotation de l'image et l'index de l'image actuelle
  const [rotation, setRotation] = useState(0);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  useEffect(() => {
    const intervalId = setInterval(() => {
      // Mise à jour de la rotation pour l'animation
  ...
  }, [images.length, animationDuration]); // Dépendances mises à jour
    ...
    <div className="bg-white">
      ...
      <div className="relative bg-blue-600 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative z-10 pt-8 pb-8 sm:pt-16 sm:pb-16 md:pt-20 md:pb-20 lg:pt-24 lg:pb-28 flex items-center justify-between">
            ...
            <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 overflow-hidden flex items-center justify-center hidden sm:flex">
              <div className={`w-[${imageSize}px] h-[${imageSize}px] rounded-[${borderRadius}px] overflow-hidden flex items-center justify-center`}>
                <img
                  key={currentImageIndex}
                  src={images[currentImageIndex]}
                  alt="Image animée"
                  className={`w-full h-full object-cover transition-transform duration-${animationDuration} ease-in-out rounded-[${borderRadius}px]`}
                  style={{ 
      ...
      <div className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* ... le reste de votre code (section Features et Footer) ... */}
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  iconPath:
                    "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2...",
                },
  ...
  <p className="text-sm text-gray-300">
    ...
    Téléphone : <a href="tel:+2290146862536" className="hover:underline">+229 01 46862536</a><br />
    Adresse : Cotonou, Bénin<br />
    LinkedIn : <a href="https://www.linkedin.com/in/mantinoubello" target="_blank" rel="noopener noreferrer" className="hover:underline">Mon profil LinkedIn</a><br />
    WhatsApp : <a href="https://wa.me/22946862536" target="_blank" rel="noopener noreferrer" className="hover:underline">Contactez-moi sur WhatsApp</a>
  </p>
</div>
